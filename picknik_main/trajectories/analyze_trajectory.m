...
while 1
    sampled_data = csvread('trajectory.csv',1,0);
    use_acceleration = 0;
    ...
    if (use_acceleration) joint1_eff=sampled_data(:,i);i=i+1; end
    joint2_pos=sampled_data(:,i);i=i+1;joint2_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) i=i+1;joint2_eff=sampled_data(:,i);i=i+1; end
    joint3_pos=sampled_data(:,i);i=i+1;joint3_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) joint3_eff=sampled_data(:,i);i=i+1; end
    joint4_pos=sampled_data(:,i);i=i+1;joint4_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) joint4_eff=sampled_data(:,i);i=i+1; end
    joint5_pos=sampled_data(:,i);i=i+1;joint5_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) joint5_eff=sampled_data(:,i);i=i+1; end
    joint6_pos=sampled_data(:,i);i=i+1;joint6_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) joint6_eff=sampled_data(:,i);i=i+1; end
    joint7_pos=sampled_data(:,i);i=i+1;joint7_vel=sampled_data(:,i);i=i+1;
    if (use_acceleration) joint7_eff=sampled_data(:,i);i=i+1; end
